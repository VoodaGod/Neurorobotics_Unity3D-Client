...
namespace GzBridgeLib
{
    public class GzBridgeWebSocketConnection
    {
		 ...
		 */
        public GzBridgeWebSocketConnection(string url)
        {
            _url = url;
            _myThread = null;
        ...
        public void Connect()
        {
            Debug.Log("Connecting to Gazebo");
        ...
        {
            Debug.Log("Disconnecting from Gazebo");
            _myThread.Abort();
